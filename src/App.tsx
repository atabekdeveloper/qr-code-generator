...
export default function App() {
  const [url, setUrl] = useState<string>('https://www.youtube.com/results?search_query=qr+code');
  ...
  }, [url, imageUrl, userDotsOptions, userCornerSquareOptions, userCornerDotOptions]);
  ...
  return (
    <div className="App flex flex-col md:flex-row">
      <div className="w-[100%] md:w-[60%] px-6 md:px-12 py-6 pb-0 h-fit md:h-screen overflow-auto flex flex-col gap-2">
        <Typography component={'h1'} fontSize={'2rem'} mb={'0.5rem'} align="center">
          QR Code Generator
        </Typography>
        ...
        <MuiColorInput
          ...
          className="inputBox"
        />
        <Select onChange={onDotsTypeChange} value={userDotsOptions.type} className="inputBox">
        ...
        <div className="flex gap-2 md:gap-6 w-full">
          <Select onChange={onExtensionChange} sx={{ width: '100%' }} value={fileExt}>
          ...
          <Button
            ...
            endIcon={
              <IoDownload size={24} style={{ color: 'white', transform: 'translateY(-2px)' }} />
            }
          >
            Download
          </Button>
